...
class Product(models.Model):
    ...
    retailer = models.ForeignKey(StoreUser, on_delete=models.CASCADE, related_name='products')
...
class Review(models.Model):
    user = models.ForeignKey(StoreUser, on_delete=models.CASCADE, to_field='original_user_id', related_name='reviews')
